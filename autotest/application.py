...
from autotest.extensions import cache, db, mail, up
from flaskext.uploads import configure_uploads
from autotest.config import defaultconfig
from autotest.helpers import get_access, get_role, get_hudson, get_result
...
def init_configure_app(app, config):
    ...
    app.config.from_envvar('autotest_SET', silent=True)
