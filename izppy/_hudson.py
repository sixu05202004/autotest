...
class Hudson(object):
    ...
    def create_node(self, name, numExecutors=5, nodeDescription=None,
                    remoteFS='/root/.hudson', labels=None, exclusive=False):
        '''
...
if __name__ == '__main__':
    ...
    a.create_node(name='10.0.2.205', exclusive=True)
    #a.reconfig_job('ADE', test)
'''