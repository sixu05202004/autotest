...
class template(object):
    head = u'''
            ...
            <boolean-property><originalValue class="boolean">false</originalValue>
            <propertyOverridden>false</propertyOverridden></boolean-property>
            </entry>

            <entry><string>hudson-plugins-disk_usage-DiskUsageProperty</string><base-property><propertyOverridden>false</propertyOverridden></base-property></entry>

            <entry><string>logRotator</string><log-rotator-property><originalValue class="hudson.tasks.LogRotator"><daysToKeep>-1</daysToKeep><numToKeep>5</numToKeep><artifactDaysToKeep>-1</artifactDaysToKeep><artifactNumToKeep>-1</artifactNumToKeep></originalValue><propertyOverridden>false</propertyOverridden></log-rotator-property></entry><entry><string>
            org-hudsonci-plugins-snapshotmonitor-WatchedDependenciesProperty
            </string><base-property><propertyOverridden>false</propertyOverridden></base-property></entry><entry><string>blockBuildWhenUpstreamBuilding</string><boolean-property><originalValue class="boolean">false</originalValue><propertyOverridden>false</propertyOverridden></boolean-property></entry><entry><string>com-tikal-hudson-plugins-notification-HudsonNotificationProperty</string><base-property><originalValue class="com.tikal.hudson.plugins.notification.HudsonNotificationProperty"><endpoints><com.tikal.hudson.plugins.notification.Endpoint><protocol>HTTP</protocol><url>%(url)s</url></com.tikal.hudson.plugins.notification.Endpoint></endpoints></originalValue><propertyOverridden>false</propertyOverridden></base-property></entry>
            ...
            <nodeName>%(node_name)s</nodeName>
            <advancedAffinityChooser>false</advancedAffinityChooser>
            <canRoam>false</canRoam></originalValue>
            <propertyOverridden>false</propertyOverridden>
            </base-property>
            </entry>
    ...
    tail = u'''
            ...
            <string>com-tikal-hudson-plugins-notification-HudsonNotificationProperty</string>
...
def build(args=None):
    ...
    mail_address = 'dengdan@izptec.com'
